      ...
      <div v-if="mobileMenuOpen" class="fixed inset-0 z-50 flex">
        ...
        <div class="relative w-4/5 max-w-sm bg-white h-full flex flex-col shadow-2xl overflow-y-auto">
          ...
          <div class="p-5 flex flex-col gap-4">
            <router-link to="/" class="font-medium text-white py-2 border-b" active-class="text-primary" exact-active-class="text-primary" @click="closeMenu">Home</router-link>
            <router-link to="/courses" class="font-medium text-white py-2 border-b" active-class="text-primary" @click="closeMenu">Courses</router-link>
            <router-link to="/categories" class="font-medium text-white py-2 border-b" active-class="text-primary" @click="closeMenu">Categories</router-link>
            <router-link to="/about" class="font-medium text-white py-2 border-b" active-class="text-primary" @click="closeMenu">About</router-link>
            <router-link v-if="isLoggedIn" :to="appRoute" class="font-medium text-white py-2 border-b" @click="closeMenu">Dashboard</router-link>
