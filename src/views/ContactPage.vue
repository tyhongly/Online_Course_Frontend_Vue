  ...
  <main class="min-h-screen bg-light pt-28 text-dark">
    <section class="border-b border-slate-200/80 bg-white py-14 sm:py-16">
      <div class="mx-auto max-w-3xl px-4 text-center sm:px-6">
        ...
        <p
          class="mx-auto mt-4 max-w-2xl text-base leading-7 text-dark-lighter sm:text-lg"
        >
          Have questions about courses, documents, or your account? Send us a
      ...
      <div class="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16 xl:gap-20">
        <aside class="lg:pt-3" aria-labelledby="contact-details-title">
          ...
          <h2
            ...
            class="mt-3 font-heading text-2xl font-bold text-dark sm:text-3xl"
          >
            Get in Touch
          </h2>
          ...
          <div class="mt-8 space-y-6">
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="mailto:support@tosrean.com"
                  class="mt-1 inline-block text-sm text-primary transition hover:text-primary-dark hover:underline"
                  >support@tosrean.com</a
                >
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <p class="mt-1 max-w-sm text-sm leading-6 text-dark-lighter">
                  Check our FAQ or Help Center for answers to common questions.
                </p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <p class="mt-1 text-sm leading-6 text-dark-lighter">
        ...
        <section
          ...
          :aria-labelledby="
            isSent ? 'contact-success-title' : 'contact-form-title'
          "
        >
          <template v-if="!isSent">
            ...
            <p class="mt-2 text-sm leading-6 text-dark-lighter">
              Tell us how we can help, and we'll take it from there.
            </p>
            ...
            >
              <div>
                ...
                <input
                  ...
                  class="block w-full rounded-xl border bg-white px-4 py-3 text-dark outline-none transition placeholder:text-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/15"
              ...
              <div>
                ...
                <input
                  ...
                  @input="errors.subject && validateField('subject')"
                />
                <p
                  v-if="errors.subject"
              ...
              <div>
                ...
                <textarea
                  ...
                  class="block w-full resize-y rounded-xl border bg-white px-4 py-3 text-dark outline-none transition placeholder:text-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/15"
                  :class="
              ...
              <button
                ...
                class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3.5 font-semibold text-white shadow-sm transition hover:bg-primary-dark focus:outline-none focus:ring-4 focus:ring-primary/25 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
              >
                <LoaderCircle
                  v-if="isSubmitting"
          ...
          <div
            v-else
            class="flex min-h-[430px] flex-col items-center justify-center px-2 py-10 text-center sm:px-10"
          >
            <span
            ...
            <h2
              ...
              class="mt-5 font-heading text-2xl font-bold text-dark"
            >
              Message Sent!
            </h2>
            <p class="mt-3 max-w-sm leading-7 text-dark-lighter">
              Thank you for contacting us. We'll get back to you as soon as
              possible.
            </p>
            <button
              type="button"
              class="mt-7 rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-semibold text-primary transition hover:border-primary/30 hover:bg-primary/5"
