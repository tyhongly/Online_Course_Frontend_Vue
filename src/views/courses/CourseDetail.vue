...
<template>
  <div v-if="course" class="bg-white min-h-screen pb-20">
      ...
      <div class="mx-auto w-full max-w-6xl px-5 sm:px-8 relative z-10 flex flex-col lg:flex-row gap-8 lg:gap-12 items-start lg:items-center">
        ...
        <div class="w-full lg:w-2/3 min-w-0">
          <div class="flex items-center gap-2 mb-4 flex-wrap">
            <span
              class="bg-primary/20 text-primary px-3 py-1 text-sm font-bold rounded-full uppercase"
          ...
          <h1
            class="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-5 sm:mb-6"
          >
            {{ course.title }}
          </h1>
          <p
            class="text-gray-600 text-base sm:text-lg leading-7 mb-6 sm:mb-8 max-w-2xl"
          >
            {{
              isDocument
                ? "Read and learn from comprehensive document lessons and practical guides."
                : "Master practical skills with in-depth video walkthroughs and expert demonstrations."
            }}
          </p>
        </div>
       ...
       <div class="w-full lg:w-1/3 min-w-0">
          <div class="w-full max-w-sm mx-auto bg-white rounded-2xl shadow-2xl p-4 sm:p-6 text-dark">
            <img
              :src="course.image"
              alt=""
              class="w-full aspect-video object-cover rounded-xl mb-6 shadow-sm"
            />
            ...
            <div class="mb-6">
              <template v-if="isDocument">
                <div class="flex items-baseline gap-2">
                  ...
                  >
                  <span
                    class="text-sm font-medium text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded"
              ...
              <template v-else>
                <div
                  class="text-3xl font-bold text-gray-800 flex items-end gap-2"
                >
                  ${{ course.price }}
                  <span
            ...
            <button
              ...
              @click="
                router.push(
                  `/learn/${course.id}/lesson/${course.lessons[0]?.id || ''}`,
                )
              "
            ...
            <div v-else class="space-y-3">
              ...
              <p class="text-xs text-gray-500 text-center leading-relaxed">
                Contact our admin on Telegram to purchase and unlock access to
                this video course.
              </p>
            </div>
            ...
            >
              <Heart
                class="h-4 w-4"
                :class="
                  wishlistStore.isWishlisted(course.id)
            ...
            <div
              class="mt-4 pt-4 border-t border-gray-100 flex items-center justify-center gap-1.5 text-xs text-gray-500 font-medium"
            >
    ...
    <div class="mx-auto w-full max-w-6xl px-5 sm:px-8 mt-8 sm:mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
      <div class="lg:col-span-2">
        ...
        >
          <div
            ...
            :key="lesson.id"
            class="p-4 flex items-start sm:items-center gap-3 justify-between hover:bg-gray-50"
          >
            <div class="flex items-center gap-3 sm:gap-4 min-w-0">
              <div
                class="w-8 h-8 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold text-sm shrink-0"
              >
                {{ idx + 1 }}
              </div>
              <div>
                <h4 class="font-bold text-gray-800 text-sm sm:text-base break-words">{{ lesson.title }}</h4>
                <p class="text-xs text-gray-500 uppercase font-medium mt-1">
                  {{ lesson.type }}
                </p>
              </div>
            </div>
      ...
      <div class="w-full">
        <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6">Course Overview</h2>
        <div
        ...
        >
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-gray-500 text-xs mt-0.5">
                {{
                  isDocument
                    ? "Structured text & document modules"
                    : "Video lectures & interactive exercises"
                }}
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-gray-500 text-xs mt-0.5">
                {{
                  isDocument ? "100% Free Forever" : "Paid via Admin Contact"
                }}
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-gray-500 text-xs mt-0.5">
                Completion badge on your dashboard
              </p>
            </div>
          </div>
        </div>
