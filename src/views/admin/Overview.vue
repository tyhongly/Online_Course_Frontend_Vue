    ...
    <div class="mx-auto flex w-full max-w-7xl flex-col gap-6">
      <section class="relative overflow-hidden rounded-2xl bg-slate-950 px-6 py-8 text-white shadow-[0_24px_60px_-38px_rgba(15,23,42,0.8)] sm:px-9 sm:py-10">
        <div class="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-indigo-200"><Activity class="h-3.5 w-3.5" /> Control center</div>
            <h1 class="mt-5 text-3xl font-semibold tracking-tight sm:text-4xl">Good to see you, {{ currentUser?.name || 'Admin' }}.</h1>
            <p class="mt-3 max-w-xl text-sm leading-6 text-slate-300">A quick view of what is happening across your learning platform today.</p>
          </div>
